...
pub mod ERC721EnumerableComponent {
    ...
    #[storage]
    pub struct Storage {
        pub ERC721Enumerable_owned_tokens: Map<(ContractAddress, u64), u64>,
        pub ERC721Enumerable_owned_tokens_index: Map<u64, u64>,
        pub ERC721Enumerable_all_tokens_len: u64,
        pub ERC721Enumerable_all_tokens: Map<u64, u64>,
        pub ERC721Enumerable_all_tokens_index: Map<u64, u64>
    }
    ...
    > of interface::IERC721Enumerable<ComponentState<TContractState>> {
        ...
        fn token_by_index(self: @ComponentState<TContractState>, index: u64) -> u64 {
    ...
    > of InternalTrait<TContractState> {
        ...
        /// hook.
        fn before_update(
            ref self: ComponentState<TContractState>, to: ContractAddress, token_id: u64
        ) {
            let erc721_component = get_dep_component!(@self, ERC721);
        ...
        fn _add_token_to_all_tokens_enumeration(
            ref self: ComponentState<TContractState>, token_id: u64
        ) {
        ...
        fn _remove_token_from_owner_enumeration(
            ref self: ComponentState<TContractState>, from: ContractAddress, token_id: u64
        ) {
            let erc721_component = get_dep_component!(@self, ERC721);
