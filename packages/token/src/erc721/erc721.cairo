...
// OpenZeppelin Contracts for Cairo v0.19.0 (token/erc721/erc721.cairo)
...
pub mod ERC721Component {
    ...
    pub struct Storage {
        ...
        pub ERC721_owners: Map<u64, ContractAddress>,
        pub ERC721_balances: Map<ContractAddress, u64>,
        pub ERC721_token_approvals: Map<u64, ContractAddress>,
    ...
    > of interface::IERC721<ComponentState<TContractState>> {
        ...
        fn balance_of(self: @ComponentState<TContractState>, account: ContractAddress) -> u64 {
        ...
        ///
        /// - `token_id` exists.
        fn owner_of(self: @ComponentState<TContractState>, token_id: u64) -> ContractAddress {
        ...
        fn approve(ref self: ComponentState<TContractState>, to: ContractAddress, token_id: u64) {
        ...
        ///
        /// - `token_id` exists.
        fn get_approved(self: @ComponentState<TContractState>, token_id: u64) -> ContractAddress {
            self._require_owned(token_id);
    ...
    > of interface::IERC721CamelOnly<ComponentState<TContractState>> {
        fn balanceOf(self: @ComponentState<TContractState>, account: ContractAddress) -> u64 {
            ERC721::balance_of(self, account)
        }

        fn ownerOf(self: @ComponentState<TContractState>, tokenId: u64) -> ContractAddress {
        ...
        fn getApproved(self: @ComponentState<TContractState>, tokenId: u64) -> ContractAddress {
    ...
    > of interface::IERC721MetadataCamelOnly<ComponentState<TContractState>> {
        fn tokenURI(self: @ComponentState<TContractState>, tokenId: u64) -> ByteArray {
    ...
    > of InternalTrait<TContractState> {
        ...
        fn exists(self: @ComponentState<TContractState>, token_id: u64) -> bool {
        ...
        ///
        /// Emits a `Transfer` event.
        fn mint(ref self: ComponentState<TContractState>, to: ContractAddress, token_id: u64) {
            assert(!to.is_zero(), Errors::INVALID_RECEIVER);
        ...
        /// Returns the owner address of `token_id`.
        fn _owner_of(self: @ComponentState<TContractState>, token_id: u64) -> ContractAddress {
    ...
    fn _check_on_erc721_received(
        from: ContractAddress, to: ContractAddress, token_id: u64, data: Span<felt252>
    ) -> bool {
