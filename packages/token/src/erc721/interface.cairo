...
// OpenZeppelin Contracts for Cairo v0.19.0 (token/erc721/interface.cairo)
...
pub trait IERC721CamelOnly<TState> {
    ...
    fn ownerOf(self: @TState, tokenId: u64) -> ContractAddress;
    fn safeTransferFrom(
        ref self: TState,
        from: ContractAddress,
        to: ContractAddress,
    ...
    fn transferFrom(ref self: TState, from: ContractAddress, to: ContractAddress, tokenId: u64);
    fn setApprovalForAll(ref self: TState, operator: ContractAddress, approved: bool);
    fn getApproved(self: @TState, tokenId: u64) -> ContractAddress;
    fn isApprovedForAll(self: @TState, owner: ContractAddress, operator: ContractAddress) -> bool;
}

#[starknet::interface]
pub trait IERC721MetadataCamelOnly<TState> {
    fn tokenURI(self: @TState, tokenId: u64) -> ByteArray;
}
